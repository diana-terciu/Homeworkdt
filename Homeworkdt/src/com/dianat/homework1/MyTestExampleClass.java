...
public class MyTestExampleClass {
	...
	public static void main(String[] args) {
		 ...
		 * so keys and values cannot be added, removed, or updated 
		 * no null keys / values are allowed
		 */
		...
		//2.
		// System.out.println( randomOptionalGenerator().orElseThrow(NullPointerException::new));
		 
		//3.
		 Optional<Integer> myOptional = randomOptionalGenerator();
		 myOptional.ifPresentOrElse(v ->  System.out.println(v), () -> System.out.println("You’ve reached the end of INT"));
	...
	public static Map<Integer, String> mapExample(){
		// Map<Integer,String> myMapExample = Map.ofEntries(entry(1, "product"), entry(2, "service"), entry(3, "agreement"));
		
		
		  HashMap<Integer, String> myMapExample = new HashMap<Integer, String>();
		  
		  myMapExample.put(1, "product"); myMapExample.put(2, "service");
...
/*6.
 * Write a method called generateViewTemplate. The view takes a Map<String,
